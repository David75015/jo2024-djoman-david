...
<head>
    ...
    <title>Gestion utilisateur - Jeux Olympiques 2024</title>
    <style>
    ...
    <main>
        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                echo "<table><tr><th>Nom</th><th>Prénom</th><th>Identifiant</th><th>Modifier</th><th>Supprimer</th></tr>";
    ...
    <script>
        ...
        function deleteUsersConfirmation(id_utilisateur) {
            ...
            if (confirm("Êtes-vous sûr de vouloir supprimer ce utilisateur?")) {
                // Ajoutez ici le code pour la suppression du utilisateur
                // alert(id_utilisateur);
